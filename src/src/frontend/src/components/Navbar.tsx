...
export function Navbar({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-[oklch(0.11_0_0)] border-b border-border flex items-center px-4 gap-4">
      {/* Logo */}
      <button
        type="button"
      ...
      <div className="flex-1 max-w-xl mx-auto relative">
        ...
        <Input
          ...
          className="pl-9 bg-muted border-border focus:border-primary/50 focus:ring-1 focus:ring-primary/30 text-sm h-9"
        />
      </div>
