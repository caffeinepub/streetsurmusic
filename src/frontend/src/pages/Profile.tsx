...
export function Profile() {
  ...
  const handleSavePlaylist = () => {
    ...
    if (editingPlaylist) {
      editPlaylist(editingPlaylist.id, { name: plName });
      toast.success("Playlist updated");
    } else {
      addPlaylist({ name: plName, songs: [] });
    ...
    <div className="space-y-8" data-ocid="profile.section">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-display text-lg font-bold">Your Playlists</h3>
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display text-lg font-bold">Your Uploads</h3>
        </div>
